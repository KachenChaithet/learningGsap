        ...
        <section id="menu" aria-labelledby="menu-heading">
            ...
            <nav className="cocktail-tabs" aria-label="Coctail Navigation">
                {allCocktails.map((cocktail, index) => {
                    ...
                    return (
                        <button key={cocktail.id} className={`${isActive ? "text-white border-white" : 'text-white/50 border-white/50'}`} onClick={() => goToSide(index)}>
                            {cocktail.name}
                        </button>
                    )
                })}
            ...
            <div className="content">
                <div className="arrows">
                    <button className="text-left" onClick={() => goToSide(currentIndex - 1)}>
                        <span>{prevCocktail.name}</span>
                        <img src="/images/right-arrow.png" alt="right-arrow" aria-hidden='true' />
                    </button>

                    <button className="text-right " onClick={() => goToSide(currentIndex + 1)} >
